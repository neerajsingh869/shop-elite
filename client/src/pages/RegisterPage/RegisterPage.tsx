  ...
  return (
    <div className="w-full h-[80vh] flex justify-center items-center">
      <div className="flex flex-col gap-6 w-84">
        ...
        <button className="border bg-zinc-950 border-zinc-800 rounded-md h-10 px-3 text-sm cursor-pointer flex gap-2 items-center justify-center  transition duration-300 hover:-translate-y-0.5 hover:border-zinc-600">
          {/* Google Icon */}
